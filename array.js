/**
 * Array Challenge Have the function ArrayChallenge(num) take the num parameter being passed and return the next 
 * number in the sequence according to the following rule: to generate the next number in a sequence read off the
